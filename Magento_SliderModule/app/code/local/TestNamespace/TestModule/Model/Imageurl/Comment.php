 ...
 */
/**
 * ImageURL comment model
 *
 * @category    TestNamespace
 * @package     TestNamespace_TestModule
 * @author      Ultimate Module Creator
 */
class TestNamespace_TestModule_Model_Imageurl_Comment extends Mage_Core_Model_Abstract
{
     ...
     */
    const ENTITY    = 'testnamespace_testmodule_imageurl_comment';
    const CACHE_TAG = 'testnamespace_testmodule_imageurl_comment';
    /**
     * Prefix of model events names
     * @var string
     */
    protected $_eventPrefix = 'testnamespace_testmodule_imageurl_comment';
