 ...
 */
class TestNamespace_TestModule_Block_Adminhtml_Imageurl_Edit_Tab_Stores extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare the form
     *
     * @access protected
     * @return TestNamespace_TestModule_Block_Adminhtml_Imageurl_Edit_Tab_Stores
     * @author Ultimate Module Creator
     */
